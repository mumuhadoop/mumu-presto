...
htmlhelp_basename = 'mumu-prestodoc'
...
latex_documents = [
    (master_doc, 'mumu-presto.tex', u'mumu-presto Documentation',
     u'babymm', 'manual'),
]
...
man_pages = [
    (master_doc, 'mumu-presto', u'mumu-presto Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mumu-presto', u'mumu-presto documentation',
     author, 'mumu-presto', 'One line description of project.',
     'Miscellaneous'),
]
